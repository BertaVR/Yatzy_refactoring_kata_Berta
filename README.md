...
This version of the refactoring Kata belongs to Emily Bage (https://github.com/emilybache/Yatzy-Refactoring-Kata), it is not mine. I just coppied the readme to my own repository so as to check for the rules more easily.
