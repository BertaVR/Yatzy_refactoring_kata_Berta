...
This version of the refactoring Kata belongs to Emily Bachee (https://github.com/emilybache/Yatzy-Refactoring-Kata), I am not the author.
I just coppied the readme to my own repository so as to be able to check the rules more easily.
